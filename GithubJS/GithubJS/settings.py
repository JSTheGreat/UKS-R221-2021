"""
Django settings for GithubJS project.
...
SECRET_KEY = 'django-insecure-lr9-d#7_+003=1w0#*ooxo%#mvu-_a9!u_3!vc8fo!cgt0m%-s'
...
WSGI_APPLICATION = 'GithubJS.wsgi.application'
